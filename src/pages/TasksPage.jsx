    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent('studyfollow-toast', {
          detail: {
            title: 'Load failed',
            message: 'Could not load tasks from Supabase.',
          },
        })
      )
    }
        ...
        window.dispatchEvent(
          new CustomEvent('studyfollow-toast', {
            detail: {
              ...
              message: 'The task moved to Done and your dashboard was updated.',
            },
          })
        )
      }
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent('studyfollow-toast', {
          detail: {
            title: 'Task restored',
            message: 'The task is back in your active list.',
          },
        })
      )
    } catch (error) {
    ...
    try {
      ...
      window.dispatchEvent(
        new CustomEvent('studyfollow-toast', {
          detail: {
            title: 'Task deleted',
            message: 'The task was removed from your list.',
          },
        })
      )
    } catch (error) {
        ...
        window.dispatchEvent(
          new CustomEvent('studyfollow-toast', {
            detail: {
              ...
              message: 'The new task is now part of your plan.',
            },
          })
        )
      }
